...
url_historicas <- read_rds(here::here("data", "url_historicas.rds"))
...
write_rds(url_historicas, here::here("data", "url_historicas.rds"))
write_rds(data_historica, here::here("data", "data_historica.rds"))

# data en excel
xlsx::write.xlsx(data_historica, here::here("data", "data_sc.xls"))
